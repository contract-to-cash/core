...
> **注**: このデモはシンプルな `Draft -> Activate -> Invoice -> Pay` フローを使用しています。決済完了後にのみサービスを開始する場合は、Suspend/Resumeステップを追加する[決済確認付きプロビジョニングフロー](../../docs/architecture.md)を参照してください。設計議論の詳細は [Issue #5](https://github.com/contract-to-cash/core/issues/5) を参照。
