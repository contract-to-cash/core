module github.com/contract-to-cash/core/tests/e2e

go 1.25.8

require (
	github.com/contract-to-cash/core v0.0.0
	github.com/k1LoW/runn v1.6.2
)
...
replace github.com/contract-to-cash/core => ../..
